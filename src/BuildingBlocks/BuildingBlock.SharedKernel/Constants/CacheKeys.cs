...
public static class CacheKeys
{
    ...
    /// Auth.Infrastructure.Caching.RefreshTokenCacheService, which owns the write side of these keys.
    /// </summary>
    ...
    /// not the enum itself - SharedKernel can't depend on Notification.Domain).
    /// </summary>
