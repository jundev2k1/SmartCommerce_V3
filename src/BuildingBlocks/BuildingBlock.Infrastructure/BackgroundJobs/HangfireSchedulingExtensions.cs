...
using BuildingBlock.Infrastructure.BackgroundJobs.Services;
...
namespace BuildingBlock.Infrastructure.BackgroundJobs;
...
/// register jobs from other assemblies (e.g. BuildingBlock.Infrastructure's cleanup jobs)
