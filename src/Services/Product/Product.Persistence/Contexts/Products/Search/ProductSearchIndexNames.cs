namespace SmartEcommerce.Product.Persistence.Contexts.Products.Search;

/// <summary>
/// The only place the literal Product Search index name lives. Since <see cref="SmartEcommerce.BuildingBlock.Search.Indexing.ElasticsearchIndexer{TDocument}"/>'s
