namespace User.Persistence.Contexts.UserProfiles.Search;

/// <summary>
/// The only place the literal User Search index name lives. Since <see cref="BuildingBlock.Search.Indexing.ElasticsearchIndexer{TDocument}"/>'s
