...
namespace Inventory.Persistence.Storage.Migrations
{
    ...
    [Migration("20260721063005_AddStockDeductionAndConcurrencyToken")]
    partial class AddStockDeductionAndConcurrencyToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.StockDeduction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_stock_deductions");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_stock_deductions_status");

                    b.ToTable("stock_deductions", (string)null);
                });
