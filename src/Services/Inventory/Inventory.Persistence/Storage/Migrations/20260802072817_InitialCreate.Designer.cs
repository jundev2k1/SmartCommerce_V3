...
namespace Inventory.Persistence.Storage.Migrations
{
    ...
    [Migration("20260802072817_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Inventories.InventoryStock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryCounts.InventoryCount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryCounts.InventoryCountItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryDocuments.InventoryDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryDocuments.InventoryDocumentItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryLots.InventoryLot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryReservations.InventoryReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventorySerials.InventorySerial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryTransactions.InventoryTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Warehouses.Warehouse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Warehouses.WarehouseZone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Inventories.InventoryStock", b =>
                {
                    b.HasOne("Inventory.Domain.Entities.Warehouses.Warehouse", "Warehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryCounts.InventoryCountItem", b =>
                {
                    b.HasOne("Inventory.Domain.Entities.InventoryCounts.InventoryCount", "InventoryCount")
                        .WithMany("Items")
                    ...
                    b.HasOne("Inventory.Domain.Entities.Inventories.InventoryStock", "Inventory")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryDocuments.InventoryDocument", b =>
                {
                    b.HasOne("Inventory.Domain.Entities.Warehouses.Warehouse", "DestinationWarehouse")
                        .WithMany()
                        .HasForeignKey("DestinationWarehouseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_inventory_documents_warehouses_destination_warehouse_id");

                    b.HasOne("Inventory.Domain.Entities.Warehouses.Warehouse", "SourceWarehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryDocuments.InventoryDocumentItem", b =>
                {
                    b.HasOne("Inventory.Domain.Entities.InventoryDocuments.InventoryDocument", "Document")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventorySerials.InventorySerial", b =>
                {
                    ...
                    b.HasOne("Inventory.Domain.Entities.InventoryReservations.InventoryReservation", "Reservation")
                        .WithMany()
