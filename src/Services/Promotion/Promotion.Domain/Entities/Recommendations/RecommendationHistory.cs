...
/// <summary>An append-only audit trail row for a RecommendationProgram - CreatedAt is inherited from BaseEntity, not redeclared. Not navigated from RecommendationProgram, so construction is public.</summary>
