...
**Phase:** 2 (Domain Model). Done so far: 2.1 (Domain Foundation + Campaign/Promotion aggregates), 2.2 (Coupon/Voucher aggregates) — see [../../../docs/promotion-service/aggregates/](../../../docs/promotion-service/aggregates/) for all four. Next: 2.3 (Loyalty + Reward + Distribution).
