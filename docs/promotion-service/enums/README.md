...
| `LoyaltyProgramStatus` | Draft, Active, Paused, Expired, Archived | `LoyaltyProgram.Status` | Given explicitly |
| `PointTransactionType` | Earn, Spend, Refund, Expire, Adjust, Reward, Promotion | `PointTransaction.Type` | Given explicitly |
| `RewardProgramStatus` | Draft, Active, Paused, Expired, Archived | `RewardProgram.Status` | Given explicitly |
